...
#region ARRAY / LIST UTILITY
	...
	public static int ContainsMatch<T>(this T[] a, T[] b)
	{
		int ind = -1;
		for(int i = 0; i < a.Length; i++)
		{
...
#region LINQ REPLACEMENT
	...
	/**
	 *	Todo - Contains is slow as shit!  Use System.Array.IndexOf
	 */
...
#region OVERRIDE
	...
	static System.Type pbVB;
	static MethodInfo setActive;
	public static void pbSetActive(this GameObject go, bool isActive)
	{
		if(setActive == null)
		{
			pbVB = Assembly.Load("Assembly-CSharp").GetTypes().First(t => t.Name == "pbVersionBridge");
			setActive = pbVB.GetMethod("SetActive");
		}
		setActive.Invoke(null, new object[2]{go, isActive});
	}
